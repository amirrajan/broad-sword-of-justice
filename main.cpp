...
void game_draw(SDL_Renderer *renderer, SDL_Texture *player_idle_texture, SDL_Texture *boss_idle_textue, BSJ_Game *game)
{
...
#endif
{
  ...
  BSJ_Game *game = (BSJ_Game *)malloc(sizeof(BSJ_Game));
  game_new(game);
